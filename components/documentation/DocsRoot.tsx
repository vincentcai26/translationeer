...
export default function DocsRoot({ paramURL }) {
  ...
  const docOptions: DocOption[] = [
    ...
    { url: "/reference", name: "Reference", isPrimary: true, num: 3 },
    { url: "/workspace", name: "Workspace", isPrimary: false, num: 4 },
    { url: "/settings", name: "Settings", isPrimary: false, num: 5 },
    { url: "/organization", name: "Organization", isPrimary: false, num: 6 },
    { url: "/definitions", name: "Definitions", isPrimary: false, num: 7 }
  ];
